...
public class BrentversalApplication {
	...
	public static void main(String[] args) {
		// .env 를 Spring 컨텍스트 시작 전에 로딩해 시스템 프로퍼티로 주입한다.
		// 이렇게 해야 application*.properties 의 ${DB_URL}, ${JWT_EXPIRATION} 등이 .env 값으로 치환된다.
		// - directory("./"): 실행 위치(모듈 루트 brentversal/)의 .env 를 읽는다.
