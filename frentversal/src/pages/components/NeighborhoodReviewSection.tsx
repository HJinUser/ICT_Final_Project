/*
  ...
  한 사람이 같은 동네에 여러 개를 남길 수 있다. 쓸 때마다 새 글로 쌓인다.

  작성자 이름은 서버가 정해서 내려준다. 일반 사용자와 중개인에게는 "익명"으로 오고,
  관리자에게만 실제 이름이 온다. 화면에서 가리는 방식이 아니라 응답 자체에 이름이 없으므로
  여기서 memberName 을 그대로 그려도 된다.
*/
